...
public class Quick_Sort {
    ...
    private static void quickSortLoop(int[] arr, int low, int high, Metrics_Tracker metrics) {
    ...
    private static int partition(int[] arr, int low, int high, Metrics_Tracker metrics) {
    ...
    private static void swap(int[] arr, int i, int j, Metrics_Tracker metrics) {
        int temp = arr[i];
        arr[i] = arr[j];
        arr[j] = temp;
    }
