...
public class Closest_Pair {
    public static double findClosestPair(Point[] points, Metrics_Tracker metrics) {
    ...
    private static double findRecursive(Point[] pointsByX, Point[] pointsByY, Metrics_Tracker metrics) {
    ...
    private static double bruteForce(Point[] points, Metrics_Tracker metrics) {
