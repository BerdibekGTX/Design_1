...
class Closest_Pair_Test {
    ...
    static void warmUpJvm() {
        for (int i = 0; i < 5000; i++) {
            ...
            Metrics_Tracker dummyMetrics = new Metrics_Tracker();
            Closest_Pair.findClosestPair(dummyPoints, dummyMetrics);
        }
    }
    ...
    public void testClosestPairWithRandomData(int size) throws IOException {
        ...
        double actualDistance = Closest_Pair.findClosestPair(points, metrics);
